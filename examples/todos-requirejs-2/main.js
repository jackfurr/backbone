(function () {
    ...
    underscore(['underscore'], function (_) {
        window._ = _; // move underscore to globabl namespace for backbone 
        bootstrap(['vendor/json2', 'order!vendor/jquery-1.6.4', 'order!root/backbone', 'order!examples/backbone-localstorage', 'order!todos.js'], function (a, b, c, d, app) {
            app.init();                
        });
    });    
}());